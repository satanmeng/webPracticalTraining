...
<body>
	<div class="message">
		...
		<div class="content">
			<div class="left">
			<img src="__PUBLIC__/dwz/themes/default/images/message-ok.jpg" />
			</div>
			<div class="right">
			...
			<?php if(!isset($closeWin)): ?><div class="row">系统将在 <span id="wait" style="color:blue;font-weight:bold"><?php echo ($waitSecond); ?></span> 秒后自动跳转,如果不想等待,直接点击 <a href="<?php echo ($jumpUrl); ?>">这里</a> 跳转</div><?php endif; ?>
			</div>
		</div>
	</div>
