...
if(!IS_CLI) {
    ...
    defined('UPLOAD_URL_EXT') or define('UPLOAD_URL_EXT', 'Public/data/');
    define('UPLOAD_PATH', SITE_PATH . UPLOAD_URL_EXT);
   
    defined('SITE_DOMAIN') or define('SITE_DOMAIN', $_SERVER['HTTP_HOST']);
    defined('SITE_URL') or define('SITE_URL', 'http://' . SITE_DOMAIN . __ROOT__ . '/');
    defined('UPLOAD_URL') or define('UPLOAD_URL', SITE_URL . UPLOAD_URL_EXT);
    defined('__UPLOAD__') or define('__UPLOAD__', UPLOAD_URL);
}
