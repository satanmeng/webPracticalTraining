...
//    $y = substr($now, 0, 4);
//    $m = substr($now, 5, 2);
//    $log_path = $log_path . $y . "/" . $m . "/";
//    if (!is_dir($log_path)) {
//        @mkdir($log_path, 0755, true); //第三个参数是“true”表示能创建多级目录
//    }
//    $pdate = substr($now, 5, 8);
//    $strlog = $now . "\t" . $sql . "\r\n";
//    $destination = $log_path . $pdate . ".txt";
//    error_log($strlog, 3, $destination);
//}

//检测端口超时情况
//function testPort($ip, $port = '3306', $second = '3') {
//    $sock = socket_create(AF_INET, SOCK_STREAM, SOL_TCP);
//    socket_set_nonblock($sock);
//    @socket_connect($sock, $ip, $port);
//    socket_set_block($sock);
//    $result = socket_select($r = array($sock), $w = array($sock), $f = array($sock), $second);
//    switch ($result) {
//        case 0:
//            $return = FALSE; //超时
//            break;
...
//    }
//    if (!$return) {
//        log::write("testPort \t" . $result, LOG::INFO);
//    }
//    return $return;
//}
